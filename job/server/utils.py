...
class HBaseUtils(object):
    ...
    def get_table_cells(self, table_name, key_format, column_format, timestamp=None, include_timestamp=False):
        """
        获取HBase数据库中多个版本数据
        :param table_name: 表名
        :param key_format: key格式字符串, 如表的'user:reco:1', 类型为bytes
...
#
#     hu = HBaseUtils(pool)
#     print(hu.get_table_row('cb_recall1',b'recall:user:10',b'als:17'))
#     print(eval(hu.get_table_row('cb_recall1',b'recall:user:10',b'als:17')))
#     print(hu.get_table_cells('cb_recall1',b'recall_user:2',b'content:18'))
