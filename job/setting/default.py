...
class DefaultConfig(object):
    ...
    # KAFKA配置
    KAFKA_SERVER = "192.168.23.129:9092"

    # redis IP和端口配置
    REDIS_HOST = "192.168.23.129"
    REDIS_PORT = 6379

    # grpc服务配置
    RPC_SERVER = "192.168.23.129:9999"
...
RAParam = param(
    ...
    RECALL={
        100: ('cb_recall1', 'als'),  # 离线模型ALS召回，recall:user:1115629498121 column=als:18
        101: ('cb_recall1', 'content'),  # 离线word2vec的画像内容召回 'recall:user:5', 'content:1'
        102: ('cb_recall1', 'online'),  # 在线word2vec的画像召回 'recall:user:1', 'online:1'
